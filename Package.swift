...
let package = Package(
  ...
  targets: [
    .target(
      name: "SignalProtocol",
      dependencies: ["Curve25519", "Protobuf"],
      path: "src",
      sources: [
      ...
      cSettings: [
         .headerSearchPath("."),
        .define("HAVE_MEMSET_S"), // if system has memset_s
        // .define("HAVE_SECUREZEROMEMORY"), // if system has SecureZeroMemory
        // .define("WORDS_BIGENDIAN") // if system is big endian
      ]),
    .target(
      name: "Curve25519",
      path: "src/curve25519",
      ...
      cSettings: [
        ...
        .headerSearchPath("ed25519/additions"),
        .headerSearchPath("ed25519/additions/generalized"),
        .headerSearchPath("ed25519/nacl_includes")
      ]),
    .target(name: "Protobuf", path: "src/protobuf-c", sources: ["protobuf-c.c"])
  ]
)
